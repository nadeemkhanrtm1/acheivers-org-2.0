...
const BlogPage: React.FC = () => {
  const article = {
    title: "Breaking Barriers: A Call Center Girl’s Journey to Empowering Her Family",
    content: [
    ...
    quote: "Never stop believing in yourself. With persistence and the right opportunities, life can change for the better.",
