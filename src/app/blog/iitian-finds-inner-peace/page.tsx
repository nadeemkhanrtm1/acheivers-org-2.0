...
const BlogPage: React.FC = () => {
  const article = {
    title:
      'Redefining Success: An IITian’s Journey to Finding Inner Peace and Fulfillment',
    content: [
    ...
    quote:
      'Success isn’t just about a high-paying job or societal approval. It’s about waking up every day with a sense of purpose and contentment. Don’t be afraid to redefine success on your own terms.',
    caption:
      'True success is finding peace in your work and joy in your journey.',
  };
